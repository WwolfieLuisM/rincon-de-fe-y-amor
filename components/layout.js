...
window.initLayout = async function (session, space) {
  ...
  const navItems = [
    ...
    { icon: '<i class="ti ti-star"></i>', label: 'Testimonios', href: 'gratitude.html' },
    { icon: '<i class="ti ti-book"></i>', label: 'La Palabra', href: 'palabra.html' },
    { icon: '<i class="ti ti-heart-handshake"></i>', label: 'Devocional', href: 'devocional.html' },
    { icon: '<i class="ti ti-message-2"></i>', label: 'Chat', href: 'encouragement.html' },
